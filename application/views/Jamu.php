    <div class="coba">
        <div class="row container kontent">
            <div class="col-sm">
                <div>
                    <h1 class="display-4">Jam-U</h1>
                    <p class="lead">Toko ini menjediakan berbagai jenis jamu, dan dibuat secara langsung demi menyediakan kesegaran dari jamu itu sendiri. dan upaya untuk melestarikan budaya tradisional</p>
                </div>

            </div>
            <div class="col-sm">
                <img class="jamu" src="<?= base_url('assets/img/content.png'); ?>" width="80%" />
            </div>
        </div>
        <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2.000000, 40.000000)" fill="#000" fill-rule="nonzero">
    ...
    <div class="produk" id="produk">
        <div class="container">
            <h1 class="display-4 text-center">Produk</h1>
            <div class="row kartu">
                <?php foreach ($data as $i) : ?>
                    <div class="col-md-3">
                        <div class="card">
                            <img src="<?= base_url('assets/img/') . $i["gambar"]; ?>" class="card-img-top img-thumbnail" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"><?= $i["nama"] ?></h5>
                                <p class="card-text">Khasiat : <?= $i["khasiat"] ?></p>
                                <a href="<?= base_url('jamu/produk/') . $i['id']; ?>" class="btn tombol">detail</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach ?>
